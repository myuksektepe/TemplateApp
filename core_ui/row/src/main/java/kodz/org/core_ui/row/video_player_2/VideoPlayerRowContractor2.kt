...
import kodz.org.core_ui.row.databinding.RowVideoPlayer2Binding
 ...
 */
class VideoPlayerRowContractor2 : BaseRowContractor() {
    ...
    private fun initRow() {
        (binding as? RowVideoPlayer2Binding)?.run {
            data?.let { data ->
    ...
    private fun onVideoReady(mp: MediaPlayer) {
        val binding = (binding as RowVideoPlayer2Binding)
